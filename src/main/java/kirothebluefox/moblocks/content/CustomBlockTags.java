...
public class CustomBlockTags {
    private static final StaticTagHelper<Block> collection = StaticTags.create(Registry.BLOCK_REGISTRY, "tags/blocks"); /*StaticTags.create(new ResourceLocation(MoBlocks.MODID, "block"), TagContainer::getBlocks);*/

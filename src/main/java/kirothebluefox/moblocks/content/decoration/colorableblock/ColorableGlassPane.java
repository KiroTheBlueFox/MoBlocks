...
public class ColorableGlassPane extends StainedGlassPaneBlock implements IColorableBlock {
	public ColorableGlassPane() {
		super(DyeColor.WHITE, Block.Properties.from(Blocks.WHITE_STAINED_GLASS_PANE));
	}

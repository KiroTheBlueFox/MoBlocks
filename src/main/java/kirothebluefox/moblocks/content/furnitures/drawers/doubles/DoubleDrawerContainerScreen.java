...
public class DoubleDrawerContainerScreen extends ContainerScreen<DoubleDrawerContainer> {
	private ResourceLocation GUI = new ResourceLocation(MoBlocks.MODID, "textures/gui/container/double_drawer.png");
	
	public DoubleDrawerContainerScreen(DoubleDrawerContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {

package kirothebluefox.moblocks.client.gui;
...
public class DoubleDrawerContainerScreen extends AbstractContainerScreen<DoubleDrawerContainer> {
    private final ResourceLocation GUI = new ResourceLocation(MoBlocks.MODID, "textures/gui/container/double_drawer.png");

    public DoubleDrawerContainerScreen(DoubleDrawerContainer screenContainer, Inventory inv, Component titleIn) {
    ...
    protected void renderLabels(PoseStack p_230451_1_, int p_230451_2_, int p_230451_3_) {
        ...
        this.font.draw(p_230451_1_, this.playerInventoryTitle.getString(), (float) this.inventoryLabelX, 104.0F, 4210752);
    }
